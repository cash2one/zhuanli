...
?><?php
$empire->query(str_replace("phome_ecms_patent",$dbtbpre."ecms_".$tbname,SetCreateTable("CREATE TABLE `phome_ecms_patent` (
...
$empire->query(str_replace("phome_ecms_patent_data_1",$dbtbpre."ecms_".$tbname."_data_1",SetCreateTable("CREATE TABLE `phome_ecms_patent_data_1` (
...
$empire->query(str_replace("phome_ecms_patent_doc",$dbtbpre."ecms_".$tbname."_doc",SetCreateTable("CREATE TABLE `phome_ecms_patent_doc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `classid` smallint(6) NOT NULL DEFAULT '0',
  `onclick` int(11) NOT NULL DEFAULT '0',
  `newspath` char(20) NOT NULL DEFAULT '',
...
$empire->query(str_replace("phome_ecms_patent_doc_data",$dbtbpre."ecms_".$tbname."_doc_data",SetCreateTable("CREATE TABLE `phome_ecms_patent_doc_data` (
  `id` int(11) NOT NULL DEFAULT '0',
  `classid` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `classid` (`classid`)
...
$empire->query(str_replace("phome_ecms_infoclass_patent",$dbtbpre."ecms_infoclass_".$tbname,SetCreateTable("CREATE TABLE `phome_ecms_infoclass_patent` (
...
$empire->query(str_replace("phome_ecms_infotmp_patent",$dbtbpre."ecms_infotmp_".$tbname,SetCreateTable("CREATE TABLE `phome_ecms_infotmp_patent` (
...
$empire->query("insert into ".$dbtbpre."enewsmod(mname,mtemp,mzs,cj,enter,tempvar,sonclass,searchvar,tid,tbname,qenter,mustqenterf,qmtemp,listandf,setandf,listtempvar,qmname,canaddf,caneditf,definfovoteid,showmod,usemod,myorder,orderf,isdefault,listfile,printtempid) values('专利系统模型','<table width=''100%'' align=center cellpadding=3 cellspacing=1 bgcolor=''#DBEAF5''><tr><td width=''16%'' height=25 bgcolor=''ffffff''>标题</td><td bgcolor=''ffffff''>[!--title--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>特殊属性</td><td bgcolor=''ffffff''>[!--special.field--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>发布时间</td><td bgcolor=''ffffff''>[!--newstime--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>申请号</td><td bgcolor=''ffffff''>[!--application_number--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>技术名称</td><td bgcolor=''ffffff''>[!--tech_name--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>专利类型</td><td bgcolor=''ffffff''>[!--patent_type--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>要解决的技术问题</td><td bgcolor=''ffffff''>[!--problem_solved--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>技术方案</td><td bgcolor=''ffffff''>[!--patent_solution--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>用途或技术领域</td><td bgcolor=''ffffff''>[!--patent_usage_field--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>附图1</td><td bgcolor=''ffffff''>[!--patent_pic1--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>附图2</td><td bgcolor=''ffffff''>[!--patent_pic2--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>分类号</td><td bgcolor=''ffffff''>[!--type_number--]</td></tr></table>','','标题<!--field--->title<!--record-->发布时间<!--field--->newstime<!--record-->申请号<!--field--->application_number<!--record-->技术名称<!--field--->tech_name<!--record-->专利类型<!--field--->patent_type<!--record-->要解决的技术问题<!--field--->problem_solved<!--record-->技术方案<!--field--->patent_solution<!--record-->用途或技术领域<!--field--->patent_usage_field<!--record-->分类号<!--field--->type_number<!--record-->','标题<!--field--->title<!--record-->特殊属性<!--field--->special.field<!--record-->发布时间<!--field--->newstime<!--record-->申请号<!--field--->application_number<!--record-->技术名称<!--field--->tech_name<!--record-->专利类型<!--field--->patent_type<!--record-->要解决的技术问题<!--field--->problem_solved<!--record-->技术方案<!--field--->patent_solution<!--record-->用途或技术领域<!--field--->patent_usage_field<!--record-->附图1<!--field--->patent_pic1<!--record-->附图2<!--field--->patent_pic2<!--record-->分类号<!--field--->type_number<!--record-->','标题<!--field--->title<!--record-->发布时间<!--field--->newstime<!--record-->申请号<!--field--->application_number<!--record-->技术名称<!--field--->tech_name<!--record-->专利类型<!--field--->patent_type<!--record-->要解决的技术问题<!--field--->problem_solved<!--record-->技术方案<!--field--->patent_solution<!--record-->用途或技术领域<!--field--->patent_usage_field<!--record-->附图1<!--field--->patent_pic1<!--record-->附图2<!--field--->patent_pic2<!--record-->分类号<!--field--->type_number<!--record-->','',',title,application_number,tech_name,problem_solved,patent_solution,patent_usage_field,type_number,',$tid,'$tbname','标题<!--field--->title<!--record-->申请号<!--field--->application_number<!--record-->技术名称<!--field--->tech_name<!--record-->专利类型<!--field--->patent_type<!--record-->要解决的技术问题<!--field--->problem_solved<!--record-->技术方案<!--field--->patent_solution<!--record-->用途或技术领域<!--field--->patent_usage_field<!--record-->附图1<!--field--->patent_pic1<!--record-->附图2<!--field--->patent_pic2<!--record-->分类号<!--field--->type_number<!--record-->',',title,application_number,tech_name,problem_solved,patent_solution,patent_usage_field,type_number,','<table width=100% align=center cellpadding=3 cellspacing=1 bgcolor=#DBEAF5><tr><td width=''16%'' height=25 bgcolor=''ffffff''>标题</td><td bgcolor=''ffffff''>[!--title--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>申请号</td><td bgcolor=''ffffff''>[!--application_number--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>技术名称</td><td bgcolor=''ffffff''>[!--tech_name--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>专利类型</td><td bgcolor=''ffffff''>[!--patent_type--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>要解决的技术问题</td><td bgcolor=''ffffff''>[!--problem_solved--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>技术方案</td><td bgcolor=''ffffff''>[!--patent_solution--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>用途或技术领域</td><td bgcolor=''ffffff''>[!--patent_usage_field--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>附图1</td><td bgcolor=''ffffff''>[!--patent_pic1--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>附图2</td><td bgcolor=''ffffff''>[!--patent_pic2--]</td></tr><tr><td width=''16%'' height=25 bgcolor=''ffffff''>分类号</td><td bgcolor=''ffffff''>[!--type_number--]</td></tr></table>','',0,'标题<!--field--->title<!--record-->发布时间<!--field--->newstime<!--record-->申请号<!--field--->application_number<!--record-->技术名称<!--field--->tech_name<!--record-->专利类型<!--field--->patent_type<!--record-->要解决的技术问题<!--field--->problem_solved<!--record-->技术方案<!--field--->patent_solution<!--record-->用途或技术领域<!--field--->patent_usage_field<!--record-->附图1<!--field--->patent_pic1<!--record-->附图2<!--field--->patent_pic2<!--record-->分类号<!--field--->type_number<!--record-->','专利信息',',title,newstime,application_number,tech_name,patent_type,problem_solved,patent_solution,patent_usage_field,patent_pic1,patent_pic2,type_number,',',title,newstime,application_number,tech_name,patent_type,problem_solved,patent_solution,patent_usage_field,patent_pic1,patent_pic2,type_number,',0,0,0,0,'',0,'',0);");
$mid=$empire->lastid();
?>